        ...
        <div class="header-control">
          ...
          <div class="header-act">
            ...
            <div class="header-act-icon header-cart">
              <?php
              if (isset($_SESSION['tai_khoan'])) {
              $count_gio_hang=fetch_array($conn,"SELECT count(*) as count from gio_hang WHERE user='{$_SESSION['tai_khoan']['ma_kh']}' LIMIT 1 ")['count'];

                echo "<a href='index.php?act=gio_hang' class='header-cart-link'>
                  <i class='fa-solid fa-cart-shopping header-cart-icon'> </i>
                </a>
                <span class='header-cart-notify'>" . $count_gio_hang . " </span>";
              } else {
                echo "<a href='index.php?act=gio_hang' class='header-cart-link'>
                <i class='fa-solid fa-cart-shopping header-cart-icon'> </i>
                </a>";
