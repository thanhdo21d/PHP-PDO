...
// Thêm hàng hóa
function them_san_pham($ten_hang_hoa, $don_gia, $giam_gia, $hinh, $ngay_nhap, $mau, $mo_ta, $thong_so, $dac_biet, $so_luot_xem, $ma_loai)
{
  $sql = "INSERT INTO hang_hoa(ten_hang_hoa, don_gia, giam_gia, hinh, ngay_nhap, mau, mo_ta, thong_so, dac_biet, so_luot_xem, ma_loai) VALUES('$ten_hang_hoa', '$don_gia', '$giam_gia', '$hinh', '$ngay_nhap', '$mau', '$mo_ta', '$thong_so', '$dac_biet', '$so_luot_xem', '$ma_loai')";
  pdo_execute($sql);
}
...
function xoa_san_pham($ma_hang_hoa)
{
...
function lay_san_pham_theo_ma($ma_hang_hoa)
{
  $sql = "SELECT * FROM hang_hoa WHERE ma_hang_hoa = $ma_hang_hoa";
